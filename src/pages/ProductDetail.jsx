      ...
      <div className="pd-container container">
        ...
        <div className="pd-breadcrumb">
          ...
          <Link to={`/shop?cat=${product.category}`}>
            {product.category === 'tshirts' ? 'T-Shirts' : 'Lowers'}
          </Link>
          <span>›</span>
          ...
          <div className="pd-info">
            ...
            <div className="pd-size-section">
              <div className="pd-size-header">
                ...
                <a href="#" className="tag size-guide-link">Size Guide →</a>
              </div>
              ...
              {!selectedSize && (
                <p className="size-hint">← Pick a size to add to cart</p>
              )}
            </div>
            ...
            <button
              ...
              onClick={handleAdd}
            >
              {added ? '✓ ADDED TO BAG' : selectedSize ? `ADD TO BAG — ₹${product.price}` : 'SELECT A SIZE FIRST'}
            </button>

            {/* Trust badges */}
            <div className="pd-badges">
              {['Free shipping ₹999+', 'COD available', 'Easy 7-day return', '100% original'].map(b => (
